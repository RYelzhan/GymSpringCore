...
VALUES
    ...
    (4, 'Michael', 'Johnson', 'michael.johnson'),
    (5, 'Emily', 'Davis', 'emily.davis'),
    (6, 'David', 'Garcia', 'david.garcia'),
    (7, 'Emma', 'Martinez', 'emma.martinez'),
    (8, 'Oliver', 'Lopez', 'oliver.lopez'),
    (9, 'Sophia', 'Gonzalez', 'sophia.gonzalez'),
    (10, 'James', 'Wilson', 'james.wilson'),
    (11, 'Charlotte', 'Moore', 'charlotte.moore'),
    (12, 'Benjamin', 'Taylor', 'benjamin.taylor'),
    (13, 'Lucas', 'Anderson', 'lucas.anderson'),
    (14, 'Amelia', 'Thomas', 'amelia.thomas'),
    (15, 'Mason', 'Jackson', 'mason.jackson'),
-- Trainers
    (16, 'Ethan', 'White', 'ethan.white'),
    (17, 'Olivia', 'Harris', 'olivia.harris'),
    (18, 'Isabella', 'Clark', 'isabella.clark'),
    (19, 'Aiden', 'Lewis', 'aiden.lewis'),
    (20, 'Ava', 'Young', 'ava.young'),
    (21, 'Jacob', 'Walker', 'jacob.walker'),
    (22, 'Liam', 'Hall', 'liam.hall'),
    (23, 'Mia', 'Allen', 'mia.allen'),
    (24, 'Noah', 'King', 'noah.king'),
    (25, 'Ella', 'Wright', 'ella.wright'),
    (26, 'William', 'Scott', 'william.scott'),
    (27, 'Abigail', 'Torres', 'abigail.torres'),
    (28, 'Elijah', 'Nguyen', 'elijah.nguyen'),
    (29, 'Avery', 'Hill', 'avery.hill'),
    (30, 'Evelyn', 'Green', 'evelyn.green');
